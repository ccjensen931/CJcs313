...
<div class="container">
    <?php
        ...
        foreach($items as $item => $data)
        {
            ...
            <div class="form-group"><div class="row"><div class="col-1"><input type="hidden" name="Item" id="' . $item . '" value="' . $item . '" placeholder="">
            <input type="text" name="Quantity" id="' . $item . '" class="form-control ml-1" value="' . $data[2] . '" placeholder="' . $data[2] . '" aria-describedby="helpId"></div></div></div><button type="submit" class="btn btn-danger">
