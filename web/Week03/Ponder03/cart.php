...
<div class="container">
    <?php
        ...
        foreach($items as $item => $data)
        {
            ...
            <input type="text" name="Quantity" id="' . $item . '" class="form-control w-10" value="' . $data[2] . '" placeholder="' . $data[2] . '" aria-describedby="helpId"></div><button type="submit" class="btn btn-danger">
